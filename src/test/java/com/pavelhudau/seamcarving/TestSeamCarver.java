...
public class TestSeamCarver {
    ...
    @Test
    void testFindVerticalSeamOnAThinPicture() {
        // GIVEN
        SeamCarver carver = new SeamCarver(getPicture1x5());
        int[] expectedVerticalSeam = new int[]{0, 1, 2, 3, 4};
    ...
    @Test
    void testFindHorizontalSeamOnAThinPicture() {
        // GIVEN
        SeamCarver carver = new SeamCarver(getPicture6x1());
        int[] expectedHorizontalSeam = new int[]{0, 1, 2, 3, 4, 5};
    ...
    private static Picture getPicture3x4() {
        Picture picture3x4 = new Picture(3, 4);
    ...
    private static Picture getPicture6x5() {
        return new Picture("src/main/resources/6x5.png");
    }

    private static Picture getPicture6x1() {
        return new Picture("src/main/resources/6x1.png");
    }

    private static Picture getPicture1x5() {
        return new Picture("src/main/resources/1x5.png");
    }

    private static Picture getSurfersPic() {
        return new Picture("src/main/resources/HJoceanSmall.png");
    }
}
